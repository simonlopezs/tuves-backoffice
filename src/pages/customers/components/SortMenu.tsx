...
import { Divider, Fab, ListItemIcon, Menu, MenuItem, Typography } from "@mui/material";
...
export const SortMenu = ({ orderBy, setOrderBy, orderDirection, setOrderDirection }: SortMenuProps) => {
    ...
    return (
        <>
            <Fab
                ...
                size='medium'
            >
                < Sort sx={{ transform: orderDirection === 'asc' ? 'scaleY(-1)' : '' }} />
            </Fab>
            ...
            >
                ...
                {directions.map(({ label, direction }) => (
                    <MenuItem key={direction} onClick={() => setOrderDirection(direction)}>
                        <ListItemIcon>
